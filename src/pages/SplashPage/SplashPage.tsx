...
export default function SplashPage(){const n=useNavigate();useEffect(()=>{const t=setTimeout(()=>n('/home',{replace:true}),1200);return()=>clearTimeout(t)},[n]);return <Wrap><Logo><Small>NOW PLAYING:</Small><K>KAMF</K><Sub>KAIST ART & MUSIC FESTIVAL</Sub></Logo><RecordArt size={220}/><Loading>2026 KAMF · LOADING</Loading></Wrap>}
